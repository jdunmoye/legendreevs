  ...
  return (
    <section className="py-20 px-6">
      <div className="container mx-auto max-w-6xl">
        <div className="bg-card shadow-lg rounded-2xl py-16 px-8 md:px-16 animate-fade-up">
          <h2 className="text-4xl md:text-5xl font-outfit font-bold mb-8 text-center text-foreground">
            Most People Who Could Build Great Software… Never Do.
          </h2>
